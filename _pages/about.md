...
My research goal is to identify the underlying computational principles and develope coordination algorithms that enable fleets of robots to **_sense_** (e.g., environmental monitoring, target search/tracking, exploration, infrastructure inspection) and **_reconfigure_** (e.g., cooperative transportation, construction, large objects assembly/disassembly) their environment in an autonomous manner that is both scalable and near-optimal. To achieve this goal, I have developed new algorithms and frameworks that unify tools and techniques from robotics, AI, operations research, and theoretical computer science communities. Moreover, my research focuses not only on creating coordination algorithms and studying their computational performance, but also on deploying these methods on mobile robots in physical settings.
