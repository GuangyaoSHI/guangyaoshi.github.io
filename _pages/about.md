...
#Research Vision
Recent advances in robotics technology have dramatically increased the capabilities of individual robots, enabling them to perform increasingly complex tasks autonomously. As robots become more ubiquitous, future applications will demand the deployment of fleets of robots working collaboratively rather than in isolation. Multi-robot systems offer unique advantages over single-robot solutions, much like a coordinated group of people outperforms an individual. Such systems can accomplish tasks more efficiently, exhibit robustness to individual failures, and enable capabilities that are unattainable by a single robot. For instance, a team of robots can rapidly collect environmental data across vast terrains, transport heavy objects that exceed the capacity of one robot, or even collaborate to construct infrastructure such as a lunar base. To realize this vision, we face a fundamental challenge: **How can we enable fleets of autonomous robots to coordinate with the capability, scalability, and efficiency of human organizations, while also automating their coordination design, deployment, and management to minimize human efforts?**

My research goal is to address such challenges by identifying the underlying computational principles and developing coordination algorithms that enable fleets of robots to **sense** (e.g., environmental monitoring, target search/tracking, exploration, infrastructure inspection) and **reconfigure** (e.g., cooperative transportation, construction, large objects assembly/disassembly) their environment in an autonomous manner that is both scalable and near-optimal. To achieve this goal, I have developed new algorithms and frameworks that unify tools and techniques from robotics, AI, operations research, and theoretical computer science communities. Moreover, my research focuses not only on creating coordination algorithms and studying their computational performance, but also on deploying these methods on mobile robots in physical settings.
...
1. **Multi-robot scientific information collection under uncertainty**: planning paths for homogeneous/heterogeneous robots to gather information in dynamic environments under robot capability constraints and environmental uncertainty (shi2021robust; shi2022risk; asghar2022risk; shi2023decision; shek2024sensor_drop; shi2020communication; Karapetyan2023coverage; shi2026_preference_adaptive).

2. **Human-in-the-loop multi-robot coordination**: developing coordination frameworks using combinatorial optimization and LLMs to enable non-expert humans to interact with robotic teams through direct action feedback or language (shi2024inverse; shi2024inverse_risk; shi2025pipllm; huang2025compositional; wu2024hierarchical).

3. **Towards a foundational model for multi-robot task planning**: constructing datasets for multi-robot task allocation and routing optimization and leveraging it to build machine learning models that can translate natural language into optimization formulations and can accelerate finding the solution of these optimization problems (huang2024LLM_routing; shi2026_foudation_MRTA; huang2026_PDDL_domain).
